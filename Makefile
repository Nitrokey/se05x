...
semver-checks:
	 ...
	 cargo semver-checks --only-explicit-features --features aes-session,builder,lpc55-v0.6
	 cargo semver-checks --only-explicit-features --features aes-session,builder,lpc55-v0.7
